...
| `mousedown` | 左键按下 | x, y, windowIndex |
| `mousedownAll` | 左键按下所有窗口 | x, y |
| `mouseup` | 左键抬起 | x, y, windowIndex |
| `mouseupAll` | 左键抬起所有窗口 | x, y |
| `mousemove` | 鼠标移动 | x, y, windowIndex |
| `mousemoveAll` | 鼠标移动所有窗口 | x, y |
